...
\fancyfoot[C]{
  \vspace{-0.5em}
  \zihaoWu 化学国家级实验教学示范中心（厦门大学）\\[1pt]
...
% ======================================================
\section{引言（一级标题为 4 号黑体）\vspace{-0.5em}}
...
% ======================================================
\section{结果与讨论（此处可以按实验内容分点，每个主题有各自的标题，结果分析和图表）\vspace{-0.5em}}
...
\multirow{2}{*}{2} & \multirow{2}{*}{3-CA, 4-CA}                  & 127/65* & 20\\
                   &                                               & 127/100 & 15\\[2pt]
\multirow{2}{*}{3} & \multirow{2}{*}{2,6-DCA}                     & 161/90* & 20\\
                   &                                               & 163/90  & 20\\[2pt]
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\linewidth]{images/img-002.jpg}
