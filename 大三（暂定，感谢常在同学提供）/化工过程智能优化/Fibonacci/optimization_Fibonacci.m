%'optimization function:[x,result]=Fibonacci(f,e)'
%'f=goal function'
%'e=minimum optimization interval'
%'x=independent variable of the minimum value'
%'result=the result of optimization'
